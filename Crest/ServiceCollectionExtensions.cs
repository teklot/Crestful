...
/// <summary>
/// Registers the Crest framework with the dependency injection container.
/// </summary>
public static class ServiceCollectionExtensions
{
    ...
    /// calling and entry assemblies, plus any assembly added to <c>CrestOptions.Assemblies</c>.
    /// </summary>
    [MethodImpl(MethodImplOptions.NoInlining)]
    public static IServiceCollection AddResources(this IServiceCollection services, Action<CrestOptions>? configure = null)
    {
        var options = new CrestOptions();
    ...
    private static void AddDiscoveryAssemblies(CrestOptions options, Assembly caller)
    {
    ...
    private static void AddAssembly(CrestOptions options, Assembly assembly)
    {
    ...
    private static void RegisterDiscoveredResources(IServiceCollection services, CrestOptions options, ResourceRegistry registry)
    {
