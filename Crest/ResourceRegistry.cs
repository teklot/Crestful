...
public sealed class ResourceRegistry
{
    ...
    public ResourceInfo Get(Type resourceType)
    {
        ...
        throw new InvalidOperationException(
            ...
            $"CrestOptions.Assemblies (via AddResources) or map it with MapResource<{resourceType.Name}>().");
    }
